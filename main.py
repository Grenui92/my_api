...
def get_one_contact(contact_id: int, db: Session = Depends(get_db)):
...
def update_contact(contact_body: ContactBase, id: int, db: Session = Depends(get_db)):
...
def search_by_name(name: str = 'Stas', db: Session = Depends(get_db)):
...
def search_by_surname(surname: str = 'Vasilenko', db: Session = Depends(get_db)):
...
def search_by_email(email: str = 'grenui@gmail.com', db: Session = Depends(get_db)):
